  ...
  <div class="inputs_grid">
    ...
    <div class="input_varieties">
      ...
      <div class="input_image">
        <img class="image js_input_image" src="FertilizersImages/Planting Fertilizers/1-ApolloDAP.png" alt="">
      </div>
      <p class="name js_input_name">DAP</p>
      <p class="price js_input_price">Ksh.3200</p>

      <button class="select_button js_input_btn" data-name="DAP" data-price="3200" data-image="FertilizersImages/Planting Fertilizers/1-ApolloDAP.png">Select</button>
    </div>
